...
public class PorcupineManager {
    ...
    public static class Builder {
        ...
        public Builder setKeywords(Porcupine.BuiltInKeyword[] keywords) {
            this.keywords = keywords;
            return this;
        }

        public Builder setKeyword(Porcupine.BuiltInKeyword keyword) {
        ...
        public Builder setErrorCallback(PorcupineManagerErrorCallback errorCallback) {
